...
The lines would completely overlap and show no difference anymore, which means, that the velocity is the same in the whole pipe.

The final hill shape can be explained by looking at the pipe which has two solid borders to the sides.
These borders result in friction, which slows down the fluid and results in slightly faster movement in the middle of the pipe.
