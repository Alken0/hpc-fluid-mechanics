...
All Shear Wave Decay experiments were run with the same parameters as shown in \cref{tab:swd-parameters}.
...
The initial condition is a given by the following equation where $L_x$ resembles the size in x-direction and $\epsilon$ resembles the initial amplitude
